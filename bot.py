...
imagenes_animo = Imagenes(["cheer up", "happiness", "super happy", "happy"], imagenes_folder+"animo.jpg")
imagenes_comida = Imagenes(["dessert", "cake", "hamburguer", "pizza", "ribs", "milkshakes", "cocktail"], imagenes_folder+"comida.jpg")
imagenes_animales = Imagenes(["cute animals", "cute cat", "cute dog", "baby bear", "cute rabbit", "cute koala", "cute penguin"], imagenes_folder+"animal.jpg")
imagenes_especiales = Imagenes(["minion", "sponge bob"], imagenes_folder+"special.jpg")
imagenes_sexy = Imagenes(["sexy", "bikini", "lingerie"], imagenes_folder+"sexy.jpg")
...
imagenes_sexy.load_imagesUrls()
imagenes_sexy.get_imagesUrl()
